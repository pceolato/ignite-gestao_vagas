...
import br.com.pedroceolato.gestao_vagas.modules.candidate.useCases.ApplyJobCandidateUseCase;
...
public class CandidateController {
    ...
    public ResponseEntity<Object> applyJob(HttpServletRequest request, @RequestBody UUID idJob) {
        ...
        try {
            var result = this.applyJobCandidateUseCase.execute(UUID.fromString(idCandidate), idJob);
